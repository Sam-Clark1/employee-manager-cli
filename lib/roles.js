...
const getAllRoles = () => {
    const sql = 'SELECT roles.title, roles.salary, departments.name AS department FROM roles LEFT JOIN departments ON roles.department_id = departments.id;'
...
const addRole = async () => {
    await inquirer.prompt([
        ...
        },
        {
            type: 'list',
            name: 'depId',
            message: 'Please enter the department id that this role belongs to.',
